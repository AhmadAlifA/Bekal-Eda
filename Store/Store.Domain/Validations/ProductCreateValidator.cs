...
{
    public ProductCreateValidator(StoreDbContext context)
    {
        RuleFor(x => x.CategoryId)
            .NotNull()
            .Must(x =>
            {
                return context.Categories.Where(o => o.Id == x).Any();
            })
            .WithName("categoryId")
        ...
        RuleFor(x => x.AttributeId)
            ...
            .Must(x =>
            {
                return context.Attributes.Where(o => o.Id == x).Any();
            })
        ...
        RuleFor(x => new { x.Name})
            .Must(x =>
             {
                 return !context.Products.Where(o => o.Name == x.Name).Any();
             })
            .WithName("name")
